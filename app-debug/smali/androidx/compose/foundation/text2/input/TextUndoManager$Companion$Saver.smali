...
.method static constructor <clinit>()V
    ...
    .local v0, "this_$iv":Landroidx/compose/foundation/text2/input/internal/undo/UndoManager$Companion;
    ...
    new-instance v3, Landroidx/compose/foundation/text2/input/TextUndoManager$Companion$Saver$special$$inlined$createSaver$1;

    invoke-direct {v3, v1}, Landroidx/compose/foundation/text2/input/TextUndoManager$Companion$Saver$special$$inlined$createSaver$1;-><init>(Landroidx/compose/runtime/saveable/Saver;)V
    ...
    .line 105
    .end local v0    # "this_$iv":Landroidx/compose/foundation/text2/input/internal/undo/UndoManager$Companion;
    .end local v1    # "itemSaver$iv":Landroidx/compose/runtime/saveable/Saver;
    .end local v2    # "$i$f$createSaver":I
    sput-object v3, Landroidx/compose/foundation/text2/input/TextUndoManager$Companion$Saver;->undoManagerSaver:Landroidx/compose/runtime/saveable/Saver;
...
.method public restore(Ljava/lang/Object;)Landroidx/compose/foundation/text2/input/TextUndoManager;
    ...
    sget-object v4, Landroidx/compose/foundation/text2/input/internal/undo/TextUndoOperation;->Companion:Landroidx/compose/foundation/text2/input/internal/undo/TextUndoOperation$Companion;

    invoke-virtual {v4}, Landroidx/compose/foundation/text2/input/internal/undo/TextUndoOperation$Companion;->getSaver()Landroidx/compose/runtime/saveable/Saver;
    ...
    check-cast v6, Landroidx/compose/foundation/text2/input/internal/undo/TextUndoOperation;
    ...
    .line 128
    :goto_0
    sget-object v2, Landroidx/compose/foundation/text2/input/TextUndoManager$Companion$Saver;->undoManagerSaver:Landroidx/compose/runtime/saveable/Saver;
    ...
    check-cast v4, Landroidx/compose/foundation/text2/input/internal/undo/UndoManager;
    ...
    .line 122
    new-instance v2, Landroidx/compose/foundation/text2/input/TextUndoManager;

    invoke-direct {v2, v6, v4}, Landroidx/compose/foundation/text2/input/TextUndoManager;-><init>(Landroidx/compose/foundation/text2/input/internal/undo/TextUndoOperation;Landroidx/compose/foundation/text2/input/internal/undo/UndoManager;)V
...
.method public save(Landroidx/compose/runtime/saveable/SaverScope;Landroidx/compose/foundation/text2/input/TextUndoManager;)Ljava/lang/Object;
    ...
    .param p2, "value"    # Landroidx/compose/foundation/text2/input/TextUndoManager;
    ...
    .line 110
    .local v2, "$i$a$-let-TextUndoManager$Companion$Saver$save$1":I
    sget-object v3, Landroidx/compose/foundation/text2/input/internal/undo/TextUndoOperation;->Companion:Landroidx/compose/foundation/text2/input/internal/undo/TextUndoOperation$Companion;

    invoke-virtual {v3}, Landroidx/compose/foundation/text2/input/internal/undo/TextUndoOperation$Companion;->getSaver()Landroidx/compose/runtime/saveable/Saver;

    move-result-object v3

    .local v3, "$this$save_u24lambda_u241_u24lambda_u240":Landroidx/compose/runtime/saveable/Saver;
    const/4 v4, 0x0

    .line 111
    .local v4, "$i$a$-with-TextUndoManager$Companion$Saver$save$1$1":I
    invoke-interface {v3, p1, v1}, Landroidx/compose/runtime/saveable/Saver;->save(Landroidx/compose/runtime/saveable/SaverScope;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    .line 110
    .end local v3    # "$this$save_u24lambda_u241_u24lambda_u240":Landroidx/compose/runtime/saveable/Saver;
    .end local v4    # "$i$a$-with-TextUndoManager$Companion$Saver$save$1$1":I
    nop

    .line 109
    .end local v1    # "it":Landroidx/compose/foundation/text2/input/internal/undo/TextUndoOperation;
    .end local v2    # "$i$a$-let-TextUndoManager$Companion$Saver$save$1":I
    goto :goto_0
    ...
    .local v1, "$this$save_u24lambda_u242":Landroidx/compose/runtime/saveable/Saver;
    const/4 v2, 0x0

    .line 115
    .local v2, "$i$a$-with-TextUndoManager$Companion$Saver$save$2":I
    ...
    invoke-interface {v1, p1, v3}, Landroidx/compose/runtime/saveable/Saver;->save(Landroidx/compose/runtime/saveable/SaverScope;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    .line 114
    .end local v1    # "$this$save_u24lambda_u242":Landroidx/compose/runtime/saveable/Saver;
    .end local v2    # "$i$a$-with-TextUndoManager$Companion$Saver$save$2":I
    const/4 v2, 0x1
...
.method public bridge synthetic save(Landroidx/compose/runtime/saveable/SaverScope;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/compose/foundation/text2/input/TextUndoManager;

    invoke-virtual {p0, p1, v0}, Landroidx/compose/foundation/text2/input/TextUndoManager$Companion$Saver;->save(Landroidx/compose/runtime/saveable/SaverScope;Landroidx/compose/foundation/text2/input/TextUndoManager;)Ljava/lang/Object;
